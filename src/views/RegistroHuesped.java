...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuespedes() {
		if (txtFechaN.getDate() != null && !txtNombre.equals("") &&
				!txtApellido.equals("") && !txtNacionalidad.getSelectedItem().toString().equals("")
				&& !txtTelefono.equals("")) {
			...
			Huespedes huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(), fechaNacimiento,
