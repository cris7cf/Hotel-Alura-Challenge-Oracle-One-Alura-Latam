...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblValorSimbolo.setFont(new Font("Roboto Black", Font.BOLD, 17));
	...
	private void guardarReserva() {
		if(txtFechaEntrada.getDate() != null && 
			...
			LocalDate fechaEntrada = LocalDate.parse(
					((JTextField)txtFechaEntrada.getDateEditor().getUiComponent()).getText());
			LocalDate fechaSalida = LocalDate.parse(
					((JTextField)txtFechaSalida.getDateEditor().getUiComponent()).getText());
			Reserva reserva = new Reserva(
					fechaEntrada, fechaSalida, txtValor.getText() + "$", txtFormaPago.getSelectedItem().toString());
		...
		if (fechaEntrada.getDate() != null && fechaSalida.getDate() != null) {
			if (fechaEntrada.getDate().after(fechaSalida.getDate())) {
				JOptionPane.showMessageDialog(null,
						"La fecha de entrada no pude ser posterior a la fecha de salida", "Error en fechas",
	...
	//Esto es para cuando modifiquemos las fechas de la tabla, se limpie el valor
